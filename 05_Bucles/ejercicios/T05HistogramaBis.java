public class T05HistogramaBis {
  public static void main(String[] args) {
    ...
    //Empezamos a mostrarlo en forma de tabla, teniendo en cuenta que hay que pinta digitoMayor +1 columnas y numeroDigitos filasç
